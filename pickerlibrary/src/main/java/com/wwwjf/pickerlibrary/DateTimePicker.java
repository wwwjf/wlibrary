package com.wwwjf.pickerlibrary;
...
import com.wwwjf.pickerlibrary.util.DateUtils;
import com.wwwjf.pickerlibrary.util.LogUtils;
import com.wwwjf.pickerlibrary.view.WheelPicker;
import com.wwwjf.pickerlibrary.view.WheelView;
...
public class DateTimePicker extends WheelPicker {
    ...
    public String getSelectedYear() {
        if (dateMode == YEAR_MONTH_DAY || dateMode == YEAR_MONTH) {
            ...
            String selectedYear = years.get(selectedYearIndex);
            selectedYear = selectedYear.substring(0,selectedYear.indexOf(yearLabel));
            return selectedYear;
        }
        return "";
    }
    ...
    public String getSelectedMonth() {
        if (dateMode != NONE) {
            ...
            String selectedMonth = months.get(selectedMonthIndex);
            selectedMonth = selectedMonth.substring(0,selectedMonth.indexOf(monthLabel));
    ...
    public String getSelectedDay() {
        if (dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) {
            ...
            String selectedDay = days.get(selectedDayIndex);
            selectedDay = selectedDay.substring(0,selectedDay.indexOf(dayLabel));
            return selectedDay;
        }
        return "";
    }
    ...
    protected View makeCenterView() {
        ...
        yearView.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT, 1.0f));
        ...
        yearView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
            ...
            public void onSelected(int index) {
                ...
                //需要根据年份及月份动态计算天数
                int selectedYear = DateUtils.trimZero(selectedYearStr.substring(0,selectedYearStr.indexOf(yearLabel)));
                changeMonthData(selectedYear);
                ...
                changeDayData(selectedYear, DateUtils.trimZero(selectedMonthStr.substring(0,selectedMonthStr.indexOf(monthLabel))));
        ...
        monthView.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT, 1.0f));
        monthView.setItems(months, selectedMonthIndex);
        ...
        dayView.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT, 1.0f));
        dayView.setItems(days, selectedDayIndex);
        ...
        if (timeMode != NONE) {
            hourView.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT, 1.0f));
            ...
            minuteView.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT, 1.0f));
            minuteView.setItems(minutes, selectedMinute);
    ...
    private int findItemIndex(ArrayList<String> items, int item) {
        ...
        int index = Collections.binarySearch(items, item, new Comparator<Object>() {
            ...
            public int compare(Object lhs, Object rhs) {
                ...
                if (lhs.toString().length() > 0) {
                    if (lhsStr.contains(yearLabel)) {
                        lhsStr = lhs.toString().substring(0, lhs.toString().indexOf(yearLabel));
                    } else if (lhsStr.contains(monthLabel)){
                        lhsStr = lhs.toString().substring(0, lhs.toString().indexOf(monthLabel));
                    } else if (lhsStr.contains(dayLabel)){
                        lhsStr = lhs.toString().substring(0, lhs.toString().indexOf(dayLabel));
                    }
                }
